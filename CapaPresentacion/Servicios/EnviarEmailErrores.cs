    ...
    public class EnviarEmailErrores
    {
            ...
            string formulario, string informacion)
        {
            ...
            try
            {
                ...
                headerEmail.Append("TICKET SOFTWARE SISClothingInventory - FECHA: " + DateTime.Now.ToLongDateString() + " HORA: " + DateTime.Now.ToLongTimeString());
                headerEmail.Append("</h2>");
                ...
                mail.From = new MailAddress(ConfigurationManager.AppSettings["eMailFrom"], "SISClothingInventory", Encoding.UTF8);
                mail.IsBodyHtml = true;
                string fecha = DateTime.Now.ToString("G");
                mail.Subject = "TICKET - Software SISClothingInventory" + " - " + fecha;
